...
const Order = async ({ params }) => {
	...
	let groupedDetails = data.order_list?.cart.checkout_product.reduce((acc, detail) => {
	...
	return (
		<>
			...
			<div className="rounded-sm border border-stroke text-black bg-white p-4 shadow-default dark:text-white dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-9 ">
								...
								<div className="flex border-2 border-gray-200 rounded-md p-4 justify-between">
									...
									<div className="text-right">
										...
										<p className="font-semibold">
											Rp
											{(detail.quantity * detail.product.price_product).toLocaleString("id-ID")}
										</p>
									</div>
								</div>
							</div>
