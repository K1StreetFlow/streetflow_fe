...
const Order = async ({ params }) => {
  ...
  let groupedDetails = data.order_list?.cart.checkout_product.reduce(
    (acc, detail) => {
      let existing = acc.find(
        (item) => item.product.name_product === detail.product.name_product
      );
      if (existing) {
    ...
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-9 ">
        ...
        <div className="p-5 mt-5 border-b-2 border-gray-200">
          ...
          <div className="flex justify-between">
            ...
            <p className="font-semibold">
              {formatDate(data.order_list?.payment.createdAt)}
            </p>
          </div>
        </div>
        <div className="p-5 border-b-2 border-gray-200">
          ...
          {groupedDetails
            ?.filter((detail) => detail.id_order === data.order_list?.id)
            .map((detail) => (
                ...
                <div className="flex border-2 border-gray-200 rounded-md p-4 justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-semibold">
                      Rp
                      {(
                        detail.quantity * detail.product.price_product
        ...
        <div className="p-5 border-b-2 border-gray-200">
          ...
          <div className="flex">
            ...
            <div>
              <p className="font-semibold">
                {data.address.user_customer.fullname}
              </p>
        ...
        <div className="p-5 border-b-2 border-gray-200">
          ...
          <div className="flex justify-between mt-4 mb-2">
            ...
            <p>
              Rp{" "}
              {data.order_list?.payment.total_payment.toLocaleString("id-ID")}
            </p>
          </div>
          <div className="flex justify-between">
