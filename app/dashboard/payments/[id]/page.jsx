...
// import { fetchData } from "../payments/api/api";

const Payment = async () => {
  // console.log(fetchDataPayment.getAllPayments());

  //   const { data } = await fetchData();

  // console.log(data[0].code_payment);
