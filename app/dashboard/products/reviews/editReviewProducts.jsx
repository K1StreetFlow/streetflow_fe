        ...
        <div className="modal-box">
          ...
          <form onSubmit={handleUpdate}>
            <div className="form-control">
              ...
              <input type="text" className="input w-full input-bordered" placeholder="Customer Name" value={review.user_customer?.fullname || ""} onChange={(e) => setUser(e.target.value)} />
            </div>
            <div className="form-control">
              <label htmlFor="name_product" className="label font-bold">
                Product Name
              </label>
              <input type="text" className="input w-full input-bordered" placeholder="Product Name" value={review.products?.name_product || ""} onChange={(e) => setProduct(e.target.value)} />
            </div>
            <div className="form-control">
              <label htmlFor="code_order" className="label font-bold">
                Code Order
              </label>
              <input type="text" className="input w-full input-bordered" placeholder="Code Order" value={review.order_list?.code_order || ""} onChange={(e) => setOrderlist(e.target.value)} />
            </div>
            <div className="form-control">
