...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      {activeTab === "personal" && <PersonalProfile userData={userData} openEditModal={openEditModal} openDeleteModal={openDeleteModal} />}
      {activeTab === "address" && <Address userData={userData} />}

      <EditModal isEditModalOpen={isEditModalOpen} closeEditModal={closeEditModal} handleEditSubmit={handleEditSubmit} editFormData={editFormData} handleChangeEdit={handleChangeEdit} />

      <DeleteModal isDeleteModalOpen={isDeleteModalOpen} closeDeleteModal={closeDeleteModal} handleDeleteAccount={handleDeleteAccount} />
    </>
  );
};
