          ...
          <div className="flex flex-col md:flex-row items-center overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-10 mt-4">
            <div className="flex flex-col items-center md:mx-30 md:my-20">
              {(userData && userData.upload_photo && (
                <div className="relative w-36 h-36 md:w-48 md:h-48 rounded-full overflow-hidden aspect-w-1 aspect-h-1 border-2 ">
                  <Image
                    src={`http://localhost:8000/${userData.upload_photo.replace(
                      "\\",
                      "/"
                    )}`}
                    alt="User Profile"
            ...
            <div className="flex flex-col items-center ml-0 md:ml-5 mt-4 md:mt-0">
              <div>
                ...
                <p className="py-2">
                  ...
                  {userData ? userData.birth_date : "Loading..."}
                </p>
                <p className="py-2">
              ...
              <div className="flex justify-center gap-4 mt-4">
                ...
                <button
                  ...
                  className="bg-danger text-white px-4 py-2 rounded-md hover:bg-danger-dark transition duration-300 ease-in-out"
                >
                  Delete Account
                </button>
              </div>
