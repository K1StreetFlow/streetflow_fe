              ...
              <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 bg-white shadow-md rounded-md">
                <div className="mb-2">
                  <label className="block mb-2">
                    Street:
                    <input type="text" name="street" value={newAddress.street} onChange={handleChange} className="w-full px-3 py-2 border rounded-md bg-white text-black" required />
                  </label>
                  <label className="block mb-2">
                    House Number:
                    <input type="text" name="house_number" value={newAddress.house_number} onChange={handleChange} className="w-full px-3 py-2 border rounded-md bg-white text-black" required />
                  </label>
                  <label className="block mb-2">
                    Zipcode:
                    <input type="text" name="zipcode" value={newAddress.zipcode} onChange={handleChange} className="w-full px-3 py-2 border rounded-md bg-white text-black" required />
                  </label>
                  <label className="block mb-2">
                    City:
                    <input type="text" name="city" value={newAddress.city} onChange={handleChange} className="w-full px-3 py-2 border rounded-md bg-white text-black" required />
                  </label>
                  <label className="block mb-2">
                    Province:
                    <input type="text" name="province" value={newAddress.province} onChange={handleChange} className="w-full px-3 py-2 border rounded-md bg-white text-black" required />
                  </label>
                </div>
