								...
								return (
									<div className="box-3 mb-4" key={key}>
													...
													.map((detail) => (
														<div className="flex" key={detail.id}>
															...
															<div>
																...
																{order.cart.checkout_product.filter((detail) => detail.id_order === order.id).length >
																	1 && (
																	<a
																	...
																	>
																		+
																		{order.cart.checkout_product.filter((detail) => detail.id_order === order.id)
																			.length - 1}{" "}
																		produk lainnya
																	</a>
																)}
										...
										<div className="flex justify-end items-center mt-7 gap-4">
											...
											{order.status_order === "Completed" && (
												<Link href="/review">
													<button className="button-ulasan" onClick={() => handleReview(order.id)}>
														Review
													</button>
												</Link>
											)}
