	...
	return (
		<div className="flex flex-col md:flex-row items-center md:space-x-6 p-6 md:p-8">
			...
			<div className="w-full md:w-1/2 text-black">
				...
				<p className=" mb-4">
					StreetFlow was founded by a group of street style fashion enthusiasts who were inspired by the diversity and
					creativity in the styles of young people in urban areas. We want to be a place for them to express themselves
					and find clothing choices that meet their desires
				</p>
