...
const ECommerce = () => {
  ...
  const [totalSuccessPayment, setTotalSuccessPayment] = useState(0);
  ...
  useEffect(() => {
    ...
    const fetchAdminData = async () => {
      try {
        ...
        console.error("Error fetching admin data from API:", error.message);
      }
    };
    ...
    const fetchOrderListData = async () => {
      try {
        ...
        let ordersCount = 0;
        let paymentAmount = 0;
        let successPaymentAmount = 0;

        response.data.data.forEach((order) => {
          ordersCount++;
          paymentAmount += order.payment.total_payment;

          // Check if the order status is "Success"
          if (order.status_order === "Paid") {
            successPaymentAmount += order.payment.total_payment;
          }
        });

        setTotalOrders(ordersCount);
        setTotalPayment(paymentAmount);
        setTotalSuccessPayment(successPaymentAmount);
      } catch (error) {
        console.error("Error fetching data from API:", error.message);
      }
    };
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total Product" total={productData.length}>
        ...
        <CardDataStats title="Total Profit" total={`Rp ${totalPayment.toLocaleString()}`}>
        ...
        <CardDataStats title="Total Users" total={userData?.length}>
        ...
        <CardDataStats title="Total Admins" total={adminData?.length}>
          <svg className="fill-primary dark:fill-white" width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M7.18418 8.03751C9.31543 8.03751 11.0686 6.35313 11.0686 4.25626C11.0686 2.15938 9.31543 0.475006 7.18418 0.475006C5.05293 0.475006 3.2998 2.15938 3.2998 4.25626C3.2998 6.35313 5.05293 8.03751 7.18418 8.03751ZM7.18418 2.05626C8.45605 2.05626 9.52168 3.05313 9.52168 4.29063C9.52168 5.52813 8.49043 6.52501 7.18418 6.52501C5.87793 6.52501 4.84668 5.52813 4.84668 4.29063C4.84668 3.05313 5.9123 2.05626 7.18418 2.05626Z"
              fill=""
