            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <Image
                          src={"/images/icon/shopping-bag-white.svg"}
                          width={20}
                          height={20}
                          alt="Products"
                        />
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/dashboard/products/photo-products"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname ===
                                  "/dashboard/products/photo-products" &&
                                "text-white"
                              }`}
                            >
                              Photo Products
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/dashboard/products/reviews" &&
                                "text-white"
                              }`}
                            >
                              Review Products
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("dashboard/order-list") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <Image
              ...
              <li>
                ...
                >
                  <Image
                    src={"/images/icon/shipping-fast-solid-white.svg"}
                    width={20}
                    height={20}
                    alt="Shipping"
                  />
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/dashboard/users/user-customers"
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname ===
                                  "/dashboard/users/user-customers" &&
                                "text-white"
                              }`}
                            >
                              User Customers
                          ...
                          <li>
                            <Link
                              href="/dashboard/users/user-administrators"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname ===
                                  "/dashboard/users/user-administrators" &&
                                "text-white"
                              }`}
                            >
                              User Administrators
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/dashboard/users/addresses" &&
                                "text-white"
                              }`}
                            >
                              Addresses
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("dashborad/profile") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <Image
                    src={"/images/icon/profile-white.svg"}
                    width={20}
                    height={20}
                    alt="Profile"
                  />
